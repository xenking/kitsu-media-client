<div class="bg-gray-700 shadow-lg h-16 fixed bottom-0 mt-12 md:relative md:h-screen z-10 w-full md:w-48">
                ...
                <a href="/news"
                   class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-blue-600">
                    <i class="fas fa-chart-area pr-0 md:pr-3 text-blue-600"></i><span
                        class="pb-1 md:pb-0 text-xs md:text-base text-white md:text-white block md:inline-block">News</span>
                </a>
            </li>
        </ul>
    </div>
