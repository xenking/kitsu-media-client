<nav class="bg-gray-700 pt-2 md:pt-1 pb-1 px-1 mt-0 h-auto fixed w-full z-20 top-0">
    ...
    <div class="flex flex-wrap items-center">
        <div class="flex flex-shrink md:w-1/3 justify-center md:justify-start text-white">
            <a href="#">
                <span class="text-yellow-500 font-bold uppercase text-xl pl-2">Kitsu media<i class="em em-grinning"></i></span>
            </a>
        </div>
        ...
        <div class="flex w-full content-center justify-between md:w-1/3 md:justify-end">
            <ul class="list-reset flex justify-between flex-1 md:flex-none items-center">
                <li class="flex-1 md:flex-none md:mr-3">
                    <a class="inline-block py-2 pt-4 px-4 text-white no-underline" href="#">
                        <i class="fa fa-bell pb-1" aria-hidden="true"></i>
                    </a>
                </li>
                <li class="flex-1 md:flex-none md:mr-3">
                    <div class="relative inline-block">
                        <button onclick="toggleDD('myDropdown')"
                                class="drop-button bg-gray-800 text-white focus:outline-none"><span class="pr-2"><i
                                class="em em-robot_face"></i></span> Hi, User
